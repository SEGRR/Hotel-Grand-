    ...
    <div class=" col-md-4 text-center bg-light border border-secondary">
        ...
        if(isset($_POST['create'])){
          ...
          $phone = $_POST['phone'];
            ...
            if($password == $checkpassword){
              ...
              $query = " INSERT INTO `users`(`email`, `password`, `first_name`, `last_name`, `phone_no`, `age`, `no_bookings`, `status`)
                        VALUES ('$email','$password','$firstname',' $lastname',' $phone','$age',0,'open')";
                  ...
                  // session_start();
                    ...
                    $_SESSION['id'] = $res['id']; 
                     ...
                     echo'<div class="alert alert-dismissible fade show alert-success" role="alert">
                          Regestration successful, Login to Continue
                          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                          </div>';
       ...
       <form action="registration.php" method="POST">
        <div class="input-group mb-3 text-light">
            ...
            <input required type="text" class="form-control" name="email" placeholder="example@email.com" aria-label="Username" aria-describedby="basic-addon1">
          </div>
          
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon2">Password</span>
            <input required type="password" name="password" class="form-control" placeholder="Must be greater than 4 digit" aria-label="Recipient's username" aria-describedby="basic-addon2">
          </div>

          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon2">Repeat password</span>
            <input required type="password" name="checkpassword" class="form-control" placeholder="Repeat Password" aria-label="Recipient's username" aria-describedby="basic-addon2">
          </div>
          
          <label for="basic-url" class="form-label">Your Data</label>
          <div class="input-group mb-3">

            <input require type="text" class="form-control" name="firstname" placeholder="Firstname" aria-label="Username">
            <span class="input-group-text">-</span>
            <input required type="text" class="form-control" name="lastname"  placeholder="Lastname" aria-label="Server">
          </div>
          
          <div class="input-group mb-3">
            <span class="input-group-text">Age</span>
            <input required type="text" class="form-control" name="age" aria-label="Amount (to the nearest dollar)">
          </div>
          ...
          <input  class="btn-primary m-3 p-1 " type="submit" name="create" value="Submit">
          <input  class="btn-primary m-3 p-1" type="reset" name="submit" value="Reset">
        </form>
    </div>
</div>
